...
| p2 · 카드 개편 후 (ADR 0008) | 6,001px (62%) | 3,184자 | 4,996자 | 카드 헤더 2줄 + 진단 아님 한 줄 + 1p 곡선 읽는 법 블록 |
| p1 · 카드 개편 후 | 4,444px (46%) | 1,982자 | 4,296자 | 접힌 카드도 헤더 2줄 |
| p4 · 카드 개편 후 | 6,215px (64%) | 3,343자 | 5,160자 | |
...
카드 개편(ADR 0008)으로 p2 기준 약 1,200px가 다시 늘었습니다. 내역은 375px에서
카드마다 헤더 2줄(결론, 쉬운 구간과 라벨과 수치. 접힌 정상 카드도 포함)과
준임상과 임상 카드의 "진단 아님" 한 줄, 곡선 높이 150에서 168, 1페이지의 "곡선 읽는 법"
블록(약 330px, 1회)입니다. 5초 안에 범위와 진단 아님이 읽히는 쪽을 길이보다
우선했고, 접힌 카드의 헤더는 척도명과 결론이 같은 줄에 들어가는 폭(데스크톱)에서는
2줄입니다.
